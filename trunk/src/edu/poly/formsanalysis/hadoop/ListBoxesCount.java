...
public class ListBoxesCount {
	
	public static final String HADOOP_TASK_NAME = "ListBoxesCount";
	...
	public static class Map extends
		...
		private IntWritable numListBoxes = new IntWritable(0);
		...
		public void map(Object key, Text value, Context context)
			...
			numListBoxes.set(_numListBoxes);
