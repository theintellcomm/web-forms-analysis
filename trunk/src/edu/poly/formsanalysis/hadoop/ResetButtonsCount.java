...
public class ResetButtonsCount {
	
	public static final String HADOOP_TASK_NAME = "ResetButtonsCount";
	...
	public static class Map extends
		...
		private IntWritable numResetButtons = new IntWritable(0);
		...
		public void map(Object key, Text value, Context context)
			...
			numResetButtons.set(_numResetButtons);

			// Write per form count
			word.set(url);
			context.write(word, numResetButtons);
			...
			word.set(numResetButtons.toString());
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(ResetButtonsCount.class);
