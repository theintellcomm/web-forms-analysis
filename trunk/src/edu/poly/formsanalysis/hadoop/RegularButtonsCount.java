...
public class RegularButtonsCount {
	
	public static final String HADOOP_TASK_NAME = "RegularButtonsCount";
	...
	public static class Map extends
		...
		private IntWritable numRegularButtons = new IntWritable(0);
		...
		public void map(Object key, Text value, Context context)
			...
			numRegularButtons.set(_numRegularButtons);

			// Write per form count
			word.set(url);
			context.write(word, numRegularButtons);
			...
			word.set(numRegularButtons.toString());
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(RegularButtonsCount.class);
