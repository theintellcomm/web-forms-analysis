...
public class SubmitButtonsCount {
	
	public static final String HADOOP_TASK_NAME = "SubmitButtonsCount";
	...
	public static class Map extends
		...
		private IntWritable numSubmitButtons = new IntWritable(0);
		...
		public void map(Object key, Text value, Context context)
			...
			numSubmitButtons.set(_numSubmitButtons);

			// Write per form count
			word.set(url);
			context.write(word, numSubmitButtons);
			...
			word.set(numSubmitButtons.toString());
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(SubmitButtonsCount.class);
