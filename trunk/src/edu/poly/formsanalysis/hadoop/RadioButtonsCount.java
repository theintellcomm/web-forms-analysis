...
public class RadioButtonsCount {
	...
	public static final String HADOOP_TASK_NAME = "RadioButtonsCount";
	...
	public static class Map extends
		...
		private IntWritable numRadioButtons = new IntWritable(0);
		...
		public void map(Object key, Text value, Context context)
			...
			numRadioButtons.set(_numRadioButtons);

			// Write per form count
			word.set(url);
			context.write(word, numRadioButtons);
			...
			word.set(numRadioButtons.toString());
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(RadioButtonsCount.class);
