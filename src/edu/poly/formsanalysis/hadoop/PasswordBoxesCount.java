...
public class PasswordBoxesCount {
	
	public static final String HADOOP_TASK_NAME = "PasswordBoxesCount";
	...
	public static class Map extends
		...
		private IntWritable numPasswordBoxes = new IntWritable(0);
		...
		public void map(Object key, Text value, Context context)
			...
			numPasswordBoxes.set(_numPasswordBoxes);

			// Write per form count
			word.set(url);
			context.write(word, numPasswordBoxes);
			...
			word.set(numPasswordBoxes.toString());
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(PasswordBoxesCount.class);
