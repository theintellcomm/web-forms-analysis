...
public class RadioButtonOptionsCount {
	
	public static final String HADOOP_TASK_NAME = "RadioButtonOptionsCount";
	...
	public static class Map extends
		...
		public void map(Object key, Text value, Context context)
			...
			Hashtable<String, Integer> radiobuttonOptions = new Hashtable<String, Integer>();
			...
			String tmp = null;
			Enumeration<String> keys = radiobuttonOptions.keys();
			while (keys.hasMoreElements()) {
				String tmpKey = keys.nextElement();
				Integer _numTypeElements = radiobuttonOptions.get(tmpKey);
